        ...
        <div className="max-w-[1280px] mx-auto px-5">
          <div className="grid grid-cols-[1.2fr_1fr] gap-14 items-center max-xl:grid-cols-1" data-aos="fade-right">
            <div>
              ...
              <p className="text-gray leading-relaxed mb-4 dark:text-gray-400">
              ...
              <p className="text-gray leading-relaxed mb-8 dark:text-gray-400">
              ...
              <div className="grid grid-cols-4 gap-5 pt-9 border-t border-gray-100 dark:border-gray-700 max-sm:grid-cols-2">
      ...
      <section className="py-24 bg-off-white dark:bg-gray-950">
        <div className="max-w-[1280px] mx-auto px-5">
          <div className="text-center mb-14" data-aos="fade-up">
            ...
            <p className="text-gray text-lg max-w-xl mx-auto dark:text-gray-400">The passionate people behind your Himalayan adventures</p>
          </div>
          <div className="grid grid-cols-4 gap-6 max-xl:grid-cols-2 max-sm:grid-cols-1">
            {team.map((member, i) => (
              <div key={i} className="text-center p-9 bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 transition-all duration-300 hover:-translate-y-1 hover:shadow-md" data-aos="fade-up" data-aos-delay={i * 100}>
                ...
                <span className="text-gray text-sm dark:text-gray-400">{member.role}</span>
              </div>
            ))}
          </div>
        </div>

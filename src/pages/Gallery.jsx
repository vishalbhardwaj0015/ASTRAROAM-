  ...
  return (
    <div>
      <section className="relative h-[350px] max-md:h-[280px] overflow-hidden">
        <img src="https://images.unsplash.com/photo-1439066615861-d1af74d74000?w=1920&h=500&fit=crop" alt="Gallery" loading="eager" className="w-full h-full object-cover" />

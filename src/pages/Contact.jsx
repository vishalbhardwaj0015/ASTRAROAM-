...
export default function Contact() {
  ...
  const inputClass = (field) =>
    `w-full px-5 py-4 border-2 rounded-xl font-body text-sm text-navy dark:text-gray-100 transition-all duration-300 bg-off-white dark:bg-gray-800 focus:outline-none focus:border-primary focus:bg-white focus:dark:bg-gray-700 focus:ring-4 focus:ring-primary/10 ${errors[field] ? 'border-red-400' : 'border-gray-100 dark:border-gray-700'}`
          ...
          <div className="grid grid-cols-4 gap-6 -mt-20 relative z-10 max-xl:grid-cols-2 max-sm:grid-cols-1">
            {contactCards.map((card, i) => (
              <a
                ...
                className="group bg-white dark:bg-gray-800 rounded-2xl p-7 shadow-glass-lg border border-gray-50 dark:border-gray-700 transition-all duration-300 hover:-translate-y-2 hover:shadow-glass-xl"
                data-aos="fade-up"
              ...
              >
                ...
                <h3 className="font-heading font-bold text-navy dark:text-gray-100 mb-1">{card.title}</h3>
                <p className="text-navy dark:text-gray-100 font-semibold text-sm mb-0.5">{card.detail}</p>
                <p className="text-gray text-xs dark:text-gray-400">{card.sub}</p>
              </a>
            ))}
          </div>
        </div>
          ...
          <div className="grid grid-cols-[1.3fr_1fr] gap-14 items-start max-xl:grid-cols-1">
            ...
            <div data-aos="fade-right">
              <div className="mb-8">
                ...
                <p className="text-gray text-base dark:text-gray-400">Fill out the form below and our travel experts will get back to you within 24 hours with a personalized itinerary.</p>
              </div>
              ...
              {submitted && (
                <div className="flex items-center gap-3 p-5 mb-8 rounded-2xl animate-slide-up" style={{ background: 'rgba(27,94,32,0.06)', border: '2px solid rgba(27,94,32,0.15)' }}>
                  ...
                  <div>
                    ...
                    <p className="text-gray text-sm dark:text-gray-400">We'll get back to you within 24 hours. Check your email.</p>
                  </div>
                </div>
              )}
              ...
              <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
                <div className="grid grid-cols-2 gap-5 max-md:grid-cols-1">
                  <div className="flex flex-col gap-2">
                    <label className="font-heading font-semibold text-sm text-navy dark:text-gray-100">Full Name *</label>
                  ...
                  <div className="flex flex-col gap-2">
                    <label className="font-heading font-semibold text-sm text-navy dark:text-gray-100">Email Address *</label>
                ...
                <div className="grid grid-cols-2 gap-5 max-md:grid-cols-1">
                  <div className="flex flex-col gap-2">
                    <label className="font-heading font-semibold text-sm text-navy dark:text-gray-100">Phone Number *</label>
                  ...
                  <div className="flex flex-col gap-2">
                    <label className="font-heading font-semibold text-sm text-navy dark:text-gray-100">Subject *</label>
                ...
                <div className="flex flex-col gap-2">
                  <label className="font-heading font-semibold text-sm text-navy dark:text-gray-100">Your Message *</label>
                  <textarea
                    rows="5"
            ...
            <div className="xl:sticky xl:top-24 space-y-6" data-aos="fade-left">
              ...
              {/* Office Info */}
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-glass-lg border border-gray-50 dark:border-gray-700">
                ...
                <div className="flex gap-4 mb-6">
                  ...
                  <div>
                    <span className="block text-[0.7rem] text-gray dark:text-gray-400 uppercase tracking-wider mb-1">Office Address</span>
                ...
                <div className="flex gap-4 mb-6">
                  ...
                  <div>
                    <span className="block text-[0.7rem] text-gray dark:text-gray-400 uppercase tracking-wider mb-1">Working Hours</span>
                    <p className="text-navy dark:text-gray-100 text-sm font-medium">Monday – Saturday: 9:00 AM – 7:00 PM</p>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <span className="block text-[0.7rem] text-gray dark:text-gray-400 uppercase tracking-wider mb-1">Response Time</span>
                    <p className="text-navy dark:text-gray-100 text-sm font-medium">Within 2 hours on working days</p>
                    <p className="text-gray text-xs dark:text-gray-400">24/7 WhatsApp support available</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-glass-lg border border-gray-50 dark:border-gray-700">
                ...
                <p className="text-gray text-sm mb-6 dark:text-gray-400">Stay connected for travel tips, stunning photos, and exclusive deals.</p>
                <div className="grid grid-cols-2 gap-3">
                  {[
                    ...
                    <a
                      ...
                      className={`flex items-center gap-3 px-4 py-3 rounded-xl bg-off-white dark:bg-gray-700 text-navy dark:text-gray-100 text-sm font-medium transition-all duration-300 hover:text-white hover:-translate-y-0.5 ${s.color}`}
                    >
                      {s.icon} {s.label}
                    </a>
                  ))}
              ...
              {/* Map */}
              <div className="rounded-2xl overflow-hidden shadow-glass-lg border border-gray-50 dark:border-gray-700">
                <iframe
